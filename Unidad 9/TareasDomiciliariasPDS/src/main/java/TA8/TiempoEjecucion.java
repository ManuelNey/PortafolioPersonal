...
public class TiempoEjecucion {
    ...
    public static void probar(int numerosProbar) {
        TClasificador clasif = new TClasificador();
        GeneradorDatosGenericos gdg = new GeneradorDatosGenericos(numerosProbar); // Tamaño ajustable
        ...
        // Heapsort
        probarYMedir(aleatorio, METODO_CLASIFICACION_HEAPSORT, "Heapsort", "aleatorio", clasif);
        probarYMedir(ascendente, METODO_CLASIFICACION_HEAPSORT, "Heapsort", "ascendente", clasif);
        probarYMedir(descendente, METODO_CLASIFICACION_HEAPSORT, "Heapsort", "descendente", clasif);
        System.out.println();
    }
