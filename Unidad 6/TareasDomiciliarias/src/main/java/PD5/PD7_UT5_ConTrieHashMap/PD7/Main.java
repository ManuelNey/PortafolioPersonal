...
public class Main {
    ...
    public static void main(String[] args){
        TTrieHashMapTelefonos trieAbonados = new TTrieHashMapTelefonos();
       ...
       // CARGAR EN EL TRIE LOS TELÉFONOS Y NOMBRES A PARTIR DEL ARCHIVO ABONADOS.TXT
        ...
        String[] lineas = manejador.leerArchivo("src/main/java/PD5/PD7_UT5_ConTrieHashMap/PD7/abonados.txt");
        ...
        manejador.escribirArchivo("src/main/java/PD5/PD7_UT5_ConTrieHashMap/PD7/abonadosFiltrados.txt", lineasParaEscritura);
